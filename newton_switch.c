...
void lcf(int n, float sumx, float sumy, float sumxy, float sumx2){
    int m = 2;
    //sumy = n.a + b.sumx
...
void pcf(int n,float sumx,float sumy,float sumxy,float sumx2,float sumx3,float sumx4, float sumx2y){
    int m = 3;
    float a[m][m+1];
...
int main(){
    ...
    printf("Enter n : ");
    scanf("%d",&n);
    float x[n],y[n],x2[n],xy[n],x3[n],x4[n],x2y[n];
    float sumx = 0, sumy = 0, sumxy = 0, sumx3 = 0, sumx4 = 0, sumx2y = 0, sumx2 = 0;
    ...
    switch(choice){
        case 1:
            lcf(n,sumx,sumy,sumxy,sumx2);
            break;
        case 2:
            pcf(n,sumx,sumy,sumxy,sumx2,sumx3,sumx4, sumx2y);
            break;
    }
